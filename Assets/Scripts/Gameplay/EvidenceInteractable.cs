...
namespace MobilOfl.Gameplay
{
    public class EvidenceInteractable : InteractableBase
    {
        ...
        [SerializeField] private string missingRequirementMessage = "Once ilgili ipucunu bulman gerekiyor.";
        ...
        private string ResolveMissingRequirementMessage()
        {
            ...
            return "Bu delili almak icin once onceki ipucunu tamamlaman gerekiyor.";
        }
